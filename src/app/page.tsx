    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-purple-900 via-blue-900 to-black p-3">
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          {message && !isLoading && (
            <div
              className={`px-4 py-2 rounded-lg text-white font-medium shadow-md transform transition-all duration-300 
              animate-fadeIn hover:scale-105 ${
                message.includes("玩家赢")
                  ? "bg-gradient-to-r from-green-500 to-emerald-600 shadow-green-600/20"
                  : message.includes("庄家赢")
                    ? "bg-gradient-to-r from-red-500 to-rose-600 shadow-rose-600/20"
                    : "bg-gradient-to-r from-blue-500 to-indigo-600 shadow-indigo-600/20"
              }`}
          ...
          <div
            className="px-4 py-2 rounded-lg bg-gray-800/90 text-amber-400 border border-gray-700/50 
          flex items-center gap-2 shadow-inner transform transition-all duration-300 hover:bg-gray-800 hover:border-amber-900/30"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
